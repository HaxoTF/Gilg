...
def get_parse() -> argparse.ArgumentParser:
    ...
    parse.add_argument("-n",  "--name",   help="Specify name of item/setting")
    parse.add_argument("-f",  "--folder", help="Specify folder path of the item")
    parse.add_argument("-l",  "--link",   help="Specify link of the item")
    parse.add_argument("-v",  "--value",  help="Specify value of specific setting")

    parse.add_argument("-lc", "--list-config", action="store_true", help="List all available settings")
    parse.add_argument("-sc", "--set-config",  action="store_true", help="Change value of single setting. Requires --name")
